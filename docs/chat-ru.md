...
| ------------- | ------------------------------------------------------------------------------------------------------------- |
| `allow`       | Без запроса                                                                                                   |
| `ask`         | Карточка (Применить / Always / Пропустить / Стоп)                                                             |
| `review`      | Edits: ConfirmCard с unified diff (Accept / Reject / Always) до записи; остальные action: heuristic ask/allow |
